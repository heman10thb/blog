        ...
        const fetchTutorial = async () => {
            ...
            try {
                ...
                setFormData({
                    ...
                    programmingTags: tutorial.programmingTags || [],
                    problemStatement: tutorial.problemStatement || '',
                    inputFormat: tutorial.inputFormat || '',
                    outputFormat: tutorial.outputFormat || '',
                    constraints: tutorial.constraints || '',
                    examples: tutorial.examples?.length > 0 ? tutorial.examples : [{ input: '', output: '', explanation: '' }],
                    solutions: {
                        python: tutorial.solutions?.python || { ...defaultSolution },
                        java: tutorial.solutions?.java || { ...defaultSolution },
                        cpp: tutorial.solutions?.cpp || { ...defaultSolution },
                        javascript: tutorial.solutions?.javascript || { ...defaultSolution }
                    },
                    approach: tutorial.approach || '',
                    complexity: tutorial.complexity || { time: '', space: '' },
                    status: tutorial.status || 'draft',
                    featured: tutorial.featured || false
                });
            } catch (err) {
                console.error('Error fetching tutorial:', err);
                setError('Failed to load tutorial. It may not exist.');
            }
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-xl border border-border p-6">
                            ...
                            <p className="text-sm">
                                Current status:
                                <span className={`ml-2 px-2 py-1 rounded-full text-xs font-medium ${formData.status === 'published'
